...
class MemberController extends Controller
{
    ...
    {
        // Pengecekan kepemilikan registrasi
        ...
        if ($request->hasFile('payment_proof')) {
            ...
            // Perbarui record di database dengan path file bukti bayar
            $registration->update([
    ...
    public function showQrCode(Registration $registration)
    {
        ...
        // 1. UBAH DARI 'png' MENJADI 'svg'
        // 2. Kita akan langsung mengirim data SVG ke view, tidak perlu disimpan sebagai file.
        $qrCodeImage = QrCode::format('svg')
                            ->size(300)
                            ->margin(4)
                            ->generate($registration->registration_code);

        // Kirim data SVG mentah ke view
        return view('member.show_qrcode', compact('qrCodeImage', 'registration'));
    }
